...
namespace NgQuestion.WebApi.Tests
{
    public static partial class AccountExtensions
    {
        ...
        /// Reference to the NgQuestion.WebApi.Tests.IAccount.
        /// </param>
        /// <param name='model'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<NgQuestion.WebApi.Tests.Models.ExternalLoginViewModel>> result = await operations.GetExternalLoginsWithOperationResponseAsync(returnUrl, generateState, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<NgQuestion.WebApi.Tests.Models.ManageInfoViewModel> result = await operations.GetManageInfoWithOperationResponseAsync(returnUrl, generateState, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<NgQuestion.WebApi.Tests.Models.UserInfoViewModel> result = await operations.GetUserInfoWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
